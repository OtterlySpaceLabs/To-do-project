...
const navigation = [{ name: "Dashboard", href: "/tasks", current: true }];
  ...
  return (
    <HydrateClient>
      <div className="min-h-full">
        <BackgroundCircles className="!-z-1 !h-max">
            ...
            <Disclosure as="nav" className="z-20">
              ...
              <DisclosurePanel className="border-b border-gray-700 md:hidden">
                <div className="flex items-center justify-between space-y-1 px-2 py-3 sm:px-3">
                  <h2 className="mr-4 pl-2 text-center text-sm text-white">
                    Bienvenue{" "}
